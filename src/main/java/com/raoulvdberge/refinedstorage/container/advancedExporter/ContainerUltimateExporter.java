...
public class ContainerUltimateExporter extends ContainerBase {

    private boolean hasRegulatorUpgrade;

    private final TileUltimateExporter exporter;

    public ContainerUltimateExporter(TileUltimateExporter exporter, EntityPlayer player) {
    ...
    public void initSlots() {
        ...
        TileUltimateExporter exporter = (TileUltimateExporter) getTile();
