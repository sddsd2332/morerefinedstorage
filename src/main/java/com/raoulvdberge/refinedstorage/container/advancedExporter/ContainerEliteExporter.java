...
public class ContainerEliteExporter extends ContainerBase {

    private boolean hasRegulatorUpgrade;

    private final TileEliteExporter exporter;

    public ContainerEliteExporter(TileEliteExporter exporter, EntityPlayer player) {
    ...
    public void initSlots() {
        ...
        TileEliteExporter exporter = (TileEliteExporter) getTile();
