package com.raoulvdberge.refinedstorage.apiimpl.network.node.advancedExporter;
...
public class NetworkNodeCreativeExporter extends NetworkNode implements IRSFilterConfigProvider, ICoverable, IUpgradeContainer {
    public static final String ID = "creativeexporter";
    ...
    private final FilterConfig config = new FilterConfig.Builder(this)
            ...
            .filterSizeNine5()
            .compareDamageAndNbt()
            .customFilterTypeSupplier(ft -> world.isRemote ? FilterType.values()[TileCreativeExporter.TYPE.getValue()] : ft).build();
    ...
    private final ItemHandlerUpgrade upgrades =
            new ItemHandlerUpgrade(4, slot -> {
                ...
                this.markNetworkNodeDirty();
                    ...
                    ItemUpgrade.TYPE_SPEED,
                    ItemUpgrade.TYPE_CRAFTING,
                    ItemUpgrade.TYPE_STACK,
                    ItemUpgrade.TYPE_REGULATOR,
                    ItemUpgrade.TYPE_EXTREME_STACK
            );
    ...
    public NetworkNodeCreativeExporter(World world, BlockPos pos) {
        super(world, pos);
    }
