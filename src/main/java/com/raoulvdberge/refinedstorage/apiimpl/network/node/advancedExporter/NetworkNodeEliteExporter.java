...
public class NetworkNodeEliteExporter extends NetworkNode implements IRSFilterConfigProvider, ICoverable, IUpgradeContainer {
    public static final String ID = "eliteexporter";
    ...
    private final FilterConfig config = new FilterConfig.Builder(this)
            ...
            .filterSizeNine3()
            .compareDamageAndNbt()
            .customFilterTypeSupplier(ft -> world.isRemote ? FilterType.values()[TileEliteExporter.TYPE.getValue()] : ft).build();
    ...
    public NetworkNodeEliteExporter(World world, BlockPos pos) {
        super(world, pos);
    }
