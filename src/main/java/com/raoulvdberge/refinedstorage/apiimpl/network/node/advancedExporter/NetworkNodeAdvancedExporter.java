...
public class NetworkNodeAdvancedExporter extends NetworkNode implements IRSFilterConfigProvider, ICoverable, IUpgradeContainer {
    public static final String ID = "advancedexporter";
    ...
    private final FilterConfig config = new FilterConfig.Builder(this)
            ...
            .filterSizeNine2()
            .compareDamageAndNbt()
            .customFilterTypeSupplier(ft -> world.isRemote ? FilterType.values()[TileAdvancedExporter.TYPE.getValue()] : ft).build();
    ...
    public NetworkNodeAdvancedExporter(World world, BlockPos pos) {
        super(world, pos);
    }
