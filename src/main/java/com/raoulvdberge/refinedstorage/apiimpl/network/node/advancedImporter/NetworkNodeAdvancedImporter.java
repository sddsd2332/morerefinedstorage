...
public class NetworkNodeAdvancedImporter extends NetworkNode implements IRSFilterConfigProvider, ICoverable, IUpgradeContainer {
    public static final String ID = "advancedimporter";
    ...
    private final FilterConfig config = new FilterConfig.Builder(this)
            ...
            .filterSizeNine2()
            .compareDamageAndNbt()
            .customFilterTypeSupplier((ft) -> world.isRemote ? FilterType.values()[TileAdvancedImporter.TYPE.getValue()] : ft).build();

    private final CoverManager coverManager = new CoverManager(this);

    private int currentSlot;

    public NetworkNodeAdvancedImporter(World world, BlockPos pos) {
        super(world, pos);
    }
