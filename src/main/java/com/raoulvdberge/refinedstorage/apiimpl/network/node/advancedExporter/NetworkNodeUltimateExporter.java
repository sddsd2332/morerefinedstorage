...
public class NetworkNodeUltimateExporter extends NetworkNode implements IRSFilterConfigProvider, ICoverable, IUpgradeContainer {
    public static final String ID = "ultimateexporter";
    ...
    private final FilterConfig config = new FilterConfig.Builder(this)
            ...
            .filterSizeNine4()
            .compareDamageAndNbt()
            .customFilterTypeSupplier(ft -> world.isRemote ? FilterType.values()[TileUltimateExporter.TYPE.getValue()] : ft).build();
    ...
    public NetworkNodeUltimateExporter(World world, BlockPos pos) {
        super(world, pos);
    }
