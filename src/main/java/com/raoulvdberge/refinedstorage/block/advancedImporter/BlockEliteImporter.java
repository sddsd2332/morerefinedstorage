...
public class BlockEliteImporter extends BlockCable {


    public BlockEliteImporter() {
        super(createBuilder("eliteimporter").tileEntity(TileEliteImporter::new).create());
    }
    ...
    public boolean onBlockActivated(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull EntityPlayer player, @Nonnull EnumHand hand, @Nonnull EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        return openNetworkGui(RSGui.ELITE_IMPORTER, player, world, pos, side);
    }
}
