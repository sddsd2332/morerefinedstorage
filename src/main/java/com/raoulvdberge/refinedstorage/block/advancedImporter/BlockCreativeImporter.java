package com.raoulvdberge.refinedstorage.block.advancedImporter;
...
public class BlockCreativeImporter extends BlockCable {


    public BlockCreativeImporter() {
        super(createBuilder("creativeimporter").tileEntity(TileCreativeImporter::new).create());
    }
    ...
    public boolean onBlockActivated(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull EntityPlayer player, @Nonnull EnumHand hand, @Nonnull EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        return openNetworkGui(RSGui.CREATIVE_IMPORTER, player, world, pos, side);
    }
}
