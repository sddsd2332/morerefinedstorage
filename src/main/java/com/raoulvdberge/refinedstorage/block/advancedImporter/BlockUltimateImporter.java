...
public class BlockUltimateImporter extends BlockCable {


    public BlockUltimateImporter() {
        super(createBuilder("ultimateimporter").tileEntity(TileUltimateImporter::new).create());
    }
    ...
    public boolean onBlockActivated(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull EntityPlayer player, @Nonnull EnumHand hand, @Nonnull EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        return openNetworkGui(RSGui.ULTIMATE_IMPORTER, player, world, pos, side);
    }
}
