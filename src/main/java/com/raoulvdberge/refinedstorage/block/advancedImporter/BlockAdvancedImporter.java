...
public class BlockAdvancedImporter extends BlockCable {


    public BlockAdvancedImporter() {
        super(createBuilder("advancedimporter").tileEntity(TileAdvancedImporter::new).create());
    }
    ...
    public boolean onBlockActivated(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull EntityPlayer player, @Nonnull EnumHand hand, @Nonnull EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        return openNetworkGui(RSGui.ADVANCED_IMPORTER, player, world, pos, side);
    }
}
