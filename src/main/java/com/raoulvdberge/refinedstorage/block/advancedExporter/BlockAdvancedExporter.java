package com.raoulvdberge.refinedstorage.block.advancedExporter;
...
public class BlockAdvancedExporter extends BlockCable {
    public BlockAdvancedExporter() {
        super(createBuilder("advancedexporter").tileEntity(TileAdvancedExporter::new).create());
    }
    ...
    public boolean onBlockActivated(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull IBlockState state, @Nonnull EntityPlayer player, @Nonnull EnumHand hand, @Nonnull EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        return openNetworkGui(RSGui.ADVANCED_EXPORTER, player, world, pos, side);
    }
}
